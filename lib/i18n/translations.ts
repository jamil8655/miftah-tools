...
export const TRANSLATIONS: Record<Language, Translations> = {
  ...
  en: {
    ...
    userDashboard: {
      ...
      myToolsSubtitle: 'Quick access to your most frequently used and pinned tools.',
      favoritesTitle: 'Bookmarked Favorites',
      favoritesSubtitle: 'Your saved collection of essential tools and starred courses.',
      historyTitle: 'Activity & Conversion History',
      historySubtitle: 'Recently processed files, opened tools, and studied lessons.',
      downloadsTitle: 'Downloads & Generated Files',
      downloadsSubtitle: 'Retrieve previously generated PDFs, images, and converted files.',
      notificationsTitle: 'Notification Center',
      notificationsSubtitle: 'Stay updated with new courses, tool releases, and platform announcements.',
      ...
      clearAll: 'Clear All',
      noHistory: 'No recent activity recorded yet. Explore tools and courses!',
      noFavorites: 'No favorite items bookmarked yet. Star any tool or course to save it.',
      noDownloads: 'No files generated yet. Process files in any tool to see downloads.',
    ...
    settings: {
      ...
      toolAlerts: 'New Tools & Feature Alerts',
    ...
    admin: {
      ...
      totalToolRuns: 'Total File Conversions',
      systemHealth: 'System Health & Services',
    ...
    footer: {
      ...
      userGuidelines: 'Usage Guidelines',
      rights: 'All rights reserved.',
      poweredBy: '100% Client-Side In-Memory Engine.',
      clientSideSecurity: 'Your files are never uploaded, stored, or tracked on any external server.',
    },
    common: {
      save: 'Save',
      cancel: 'Cancel',
    ...
    quiz: {
      ...
      subtitle: 'Test your understanding across Fullstack Web, Python AI, and Document Automation.',
      startQuiz: 'Start Quiz Now',
      nextQuestion: 'Next Question',
      prevQuestion: 'Previous Question',
      submitQuiz: 'Submit & View Score',
      score: 'Your Score',
      ...
      congratulations: 'Excellent job! You demonstrated great command over this subject.',
    ...
    dialogs: {
      ...
      searchModalTitle: 'Platform Global Search',
    ...
    errors: {
      ...
      fileTooLarge: 'The selected file exceeds the 500MB client-side limit.',
      invalidFileType: 'Unsupported file type. Please select a valid document or image.',
  ...
  // ==================== ARABIC (العربية) ====================
  ar: {
    appName: 'مفتاح تولز برو',
    tagline: 'منصة شاملة لأدوات الملفات الاحترافية والتعليم الرقمي فائق الأمان.',
    heroTitle: 'أتقن المهارات الرقمية وحوّل جميع ملفاتك في مساحة عمل واحدة',
    heroSubtitle: 'تعلم تطوير الويب الحديث والذكاء الاصطناعي مع أكثر من 220 أداة سريعة وخاصة تعمل محلياً 100% دون رفع ملفاتك إلى أي خادم.',
    searchPlaceholder: 'ابحث في أكثر من 220 أداة ودورة (مثل: تحويل PDF إلى Word، ضغط الصور، تنسيق JSON)...',
    popularTools: 'الأدوات الشائعة والأساسية',
    allTools: 'جميع الأدوات الرقمية (220+)',
    exploreCategories: 'استكشف حسب الفئات',
    privacyNotice: 'صفر رفع إلى الخوادم • معالجة محلية خاصة وآمنة 100%.',
    clientSideBadge: 'معالجة محلية بالكامل (خصوصية 100%)',
    serverSideBadge: 'محرك سحابي',
    dropzoneTitle: 'اسحب وأفلت ملفاتك هنا',
    dropzoneSubtitle: 'أو انقر لاختيار الملفات من جهازك مباشرة',
    chooseFiles: 'اختر الملفات',
    processing: 'جارٍ معالجة الملفات بأمان...',
    download: 'تحميل النتيجة',
    downloadAllZip: 'تحميل الكل (ملف ZIP مضغوط)',
    ...
    nav: {
      ...
      aiTools: 'مساحة الذكاء الاصطناعي',
      pdfEditor: 'محرر PDF',
      workflows: 'سير العمل',
      allTools: 'الأدوات',
    ...
    auth: {
      ...
      enterEmailPassword: 'يرجى إدخال كل من البريد الإلكتروني وكلمة المرور.',
      ...
      enterEmailForReset: 'يرجى إدخال عنوان بريدك الإلكتروني لتلقي رابط إعادة التعيين.',
      authSubtitle: 'مصادقة آمنة ومحلية بالكامل 100%',
    },
    userDashboard: {
    ...
    quiz: {
      ...
      subtitle: 'اختبر مدى فهمك واستيعابك في مجالات تطوير الويب والذكاء الاصطناعي وأتمتة المستندات.',
      startQuiz: 'بدء الاختبار الآن',
      nextQuestion: 'السؤال التالي',
      prevQuestion: 'السؤال السابق',
      submitQuiz: 'إرسال وعرض النتيجة',
      score: 'درجتك في الاختبار',
      passed: 'تهانينا! لقد اجتزت الاختبار بنجاح 🎉',
      failed: 'واصل التدريب وحاول مرة أخرى',
      retake: 'إعادة الاختبار',
      explanation: 'الشرح والإيضاح',
      question: 'السؤال',
      of: 'من',
      correctAnswer: 'الإجابة الصحيحة',
      yourAnswer: 'إجابتك',
      congratulations: 'عمل رائع ومميز! لقد أظهرت كفاءة عالية وفهماً عميقاً للموضوع.',
      tryAgain: 'راجع دروس الدورة وحاول مرة أخرى لتحسين نتيجتك والحصول على الدرجة الكاملة.',
      selectQuiz: 'اختر موضوع الاختبار',
    },
    dialogs: {
      confirmTitle: 'تأكيد الإجراء',
      confirmMessage: 'هل أنت متأكد من رغبتك في متابعة هذا الإجراء؟',
      ...
      searchModalPlaceholder: 'ابحث في أكثر من 220 أداة ودورة ودرس...',
    },
    errors: {
      general: 'حدث خطأ غير متوقع. يرجى المحاولة مرة أخرى.',
      notFound: 'الصفحة أو المورد المطلوب غير موجود.',
      unauthorized: 'يجب تسجيل الدخول للوصول إلى هذه الميزة.',
  ...
  ur: {
    ...
    heroSubtitle: 'جدید ویب ڈیولپمنٹ، اے آئی اور دستاویزات کی مہارت حاصل کریں اور 220 سے زائد تیز رفتار پرائیویٹ ٹولز بغیر کسی سرور اپلوڈ کے استعمال کریں۔',
    searchPlaceholder: '220+ ٹولز، کورسز یا ایکشنز تلاش کریں (مثلاً پی ڈی ایف سے ورڈ، امیج کمپریس)...',
    popularTools: 'مقبول اور اہم ٹولز',
    allTools: 'تمام 220+ ڈیجیٹل ٹولز',
    ...
    auth: {
      ...
      registrationFailed: 'رجسٹریشن ناکام ہوگئی۔ براہ کرم دوبارہ کوشش کریں۔',
      enterEmailForReset: 'ری سیٹ لنک حاصل کرنے کے لیے اپنا ای میل درج کریں۔',
      authSubtitle: 'خالصتاً کلائنٹ سائیڈ محفوظ تصدیق',
    },
    userDashboard: {
    ...
    admin: {
      ...
      totalToolRuns: 'کل پروسیس شدہ فائلیں',
      systemHealth: 'سسٹم کی صحت اور سروسز',
      addCourse: 'نیا کورس شامل کریں',
      editCourse: 'کورس تبدیل کریں',
      deleteCourse: 'کورس ختم کریں',
      publishCourse: 'شائع کریں',
      draftCourse: 'ڈرافٹ محفوظ کریں',
      enableTool: 'ٹول چالو کریں',
      disableTool: 'ٹول بند کریں',
      searchUsers: 'نام، ای میل یا رول سے یوزر تلاش کریں...',
      roleAdmin: 'ایڈمنسٹریٹر (Admin)',
      roleUser: 'عام صارف',
      makeAdmin: 'ایڈمن بنائیں',
      removeAdmin: 'صارف میں تبدیل کریں',
    ...
    footer: {
      ...
      tools: 'تمام ٹولز (220+)',
      features: 'خصوصیات اور پرائیویسی',
      ...
      userGuidelines: 'استعمال کے رہنما اصول',
      rights: 'جملہ حقوق محفوظ ہیں۔',
      poweredBy: '100% کلائنٹ سائیڈ محفوظ انجن۔',
      clientSideSecurity: 'آپ کی فائلیں کسی بھی بیرونی سرور پر اپلوڈ یا محفوظ نہیں کی جاتیں۔',
    },
    common: {
      save: 'محفوظ کریں',
      cancel: 'منسوخ کریں',
    ...
    dialogs: {
      ...
      searchModalPlaceholder: '220+ ٹولز، کورسز، اسباق اور ورک فلوز تلاش کریں...',
    },
    errors: {
  ...
  hi: {
    ...
    heroSubtitle: 'आधुनिक वेब, एआई और दस्तावेज़ विशेषज्ञता सीखें और बिना किसी सर्वर अपलोड के 220+ तेज़, 100% निजी क्लाइंट-साइड टूल्स का उपयोग करें।',
    searchPlaceholder: '220+ टूल्स, कोर्सेज या एक्शन खोजें (जैसे: PDF to Word, Image Compress, JSON Formatter)...',
    popularTools: 'लोकप्रिय और आवश्यक टूल्स',
    allTools: 'सभी 220+ डिजिटल टूल्स',
    ...
    courses: {
      title: 'मास्टर कोर्सेज एक्सप्लोर करें',
      ...
      browse: 'कोर्सेज ब्राउज़ करें',
      myCourses: 'मेरे नामांकित कोर्सेज',
      ...
      benefit3: 'इंटरैक्टिव प्रोजेक्ट फ़ाइलों और डाउनलोड करने योग्य टेम्पलेट्स तक पहुँचें',
      ...
      searchCourses: 'शीर्षक, विषय या तकनीक द्वारा कोर्सेज खोजें...',
    ...
    auth: {
      ...
      invalidCredentials: 'गलत ईमेल या पासवर्ड। कृपया जांच कर पुनः प्रयास करें।',
      ...
      enterEmailForReset: 'रीसेट लिंक प्राप्त करने के लिए अपना ईमेल दर्ज करें।',
      authSubtitle: 'विशुद्ध रूप से ऑन-डिवाइस सुरक्षित प्रमाणीकरण',
    },
    userDashboard: {
      welcomeBack: 'वापसी पर स्वागत है',
      overview: 'खाता अवलोकन',
      myToolsTitle: 'मेरे टूल्स और शॉर्टकट',
      myToolsSubtitle: 'अपने सबसे अधिक उपयोग किए जाने वाले और पिन किए गए टूल्स तक तुरंत पहुँचें।',
      favoritesTitle: 'पसंदीदा बुकमार्क',
      favoritesSubtitle: 'आपके सहेजे गए टूल्स और पसंदीदा कोर्सेज की सूची।',
      ...
      downloadsSubtitle: 'अपनी बनाई गई PDF, इमेज और कन्वर्ट की गई फ़ाइलें पुनः डाउनलोड करें।',
      notificationsTitle: 'सूचना केंद्र',
      notificationsSubtitle: 'नए कोर्सेज, टूल अपडेट्स और प्लेटफ़ॉर्म घोषणाओं से अपडेट रहें।',
      ...
      noHistory: 'अभी कोई गतिविधि रिकॉर्ड नहीं हुई है। टूल्स और कोर्सेज एक्सप्लोर करें!',
    ...
    admin: {
      ...
      totalCourses: 'प्रकाशित कोर्सेज',
      totalToolRuns: 'कुल प्रोसेस की गई फ़ाइलें',
      systemHealth: 'सिस्टम स्वास्थ्य और सेवाएं',
    ...
    footer: {
      ...
      tools: 'सभी टूल्स (220+)',
      features: 'विशेषताएं और गोपनीयता',
      ...
      userGuidelines: 'उपयोग दिशानिर्देश',
      rights: 'सर्वाधिकार सुरक्षित।',
      poweredBy: '100% क्लाइंट-साइड सुरक्षित इंजन।',
      clientSideSecurity: 'आपकी फ़ाइलें किसी भी बाहरी सर्वर पर कभी भी अपलोड या ट्रैक नहीं की जाती हैं।',
    },
    common: {
      save: 'सहेजें',
      cancel: 'रद्द करें',
    ...
    quiz: {
      title: 'कौशल मूल्यांकन और क्विज़',
      subtitle: 'फुलस्टैक वेब, पायथन एआई और दस्तावेज़ स्वचालन में अपनी समझ का परीक्षण करें।',
      startQuiz: 'क्विज़ शुरू करें',
      nextQuestion: 'अगला प्रश्न',
      prevQuestion: 'पिछला प्रश्न',
      submitQuiz: 'जमा करें और स्कोर देखें',
      score: 'आपका स्कोर',
      passed: 'बधाई हो! आप उत्तीर्ण हुए 🎉',
      failed: 'अभ्यास जारी रखें और पुनः प्रयास करें',
      retake: 'पुनः क्विज़ दें',
      explanation: 'व्याख्या और मुख्य बिंदु',
      question: 'प्रश्न',
      of: 'का',
      correctAnswer: 'सही उत्तर',
      yourAnswer: 'आपका उत्तर',
      congratulations: 'बहुत बढ़िया! आपने इस विषय पर उत्कृष्ट समझ प्रदर्शित की।',
      tryAgain: 'पाठों की समीक्षा करें और अपना स्कोर सुधारने के लिए पुनः प्रयास करें।',
      selectQuiz: 'परीक्षण के लिए विषय चुनें',
    },
    dialogs: {
      confirmTitle: 'कार्रवाई की पुष्टि करें',
      confirmMessage: 'क्या आप वाकई यह कार्रवाई जारी रखना चाहते हैं?',
      deleteConfirmation: 'यह आइटम आपके कार्यक्षेत्र से स्थायी रूप से हटा दिया जाएगा।',
      saveChanges: 'बदलाव सहेजें',
      discardChanges: 'रद्द करें',
      searchModalTitle: 'प्लेटफ़ॉर्म ग्लोबल खोज',
      searchModalPlaceholder: '220+ टूल्स, कोर्सेज, पाठ और वर्कफ़्लो खोजें...',
    },
    errors: {
      general: 'एक अनपेक्षित त्रुटि हुई। कृपया पुनः प्रयास करें।',
      notFound: 'अनुरोधित पृष्ठ या संसाधन नहीं मिला।',
      unauthorized: 'इस सुविधा का उपयोग करने के लिए आपको लॉग इन करना होगा।',
      fileTooLarge: 'चयनित फ़ाइल 500MB की क्लाइंट-साइड सीमा से बड़ी है।',
      invalidFileType: 'असमर्थित फ़ाइल प्रकार। कृपया वैध दस्तावेज़ या छवि चुनें।',
      networkError: 'नेटवर्क कनेक्शन समस्या। कृपया अपना इंटरनेट जांचें।',
      tryAgainLater: 'समय समाप्त हो गया। कृपया कुछ क्षणों बाद पुनः प्रयास करें।',
    },
  },
};
