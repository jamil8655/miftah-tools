        ...
        <div className="p-6 sm:p-10 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-8 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <section className="space-y-4 p-5 sm:p-6 rounded-2xl bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-200/80 dark:border-emerald-900/40">
            <div className="flex items-center gap-2.5 text-emerald-900 dark:text-emerald-300 font-bold text-sm sm:text-base">
              ...
              <span>6. Data Safety &amp; Instant Data Deletion (डेटा सुरक्षा और स्थानीय डेटा डिलीट नीति)</span>
            </div>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300">
              Miftah Tools is <strong>100% Login-Free &amp; Registration-Free</strong>. We do not store any accounts, passwords, or personal databases on any server. Users retain complete control over all data stored locally on their device:
            </p>
            ...
            <div className="space-y-3 pt-1">
              <div className="p-3.5 rounded-xl bg-white dark:bg-slate-900 border border-emerald-200 dark:border-emerald-900/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white text-xs flex items-center gap-1.5">
                  ...
                  Method A: 1-Tap In-App Data Purge (ऐप के अंदर से तुरंत डेटा हटाएं)
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-400">
                  You can purge your entire offline history, recent tools, and bookmarks at any moment by navigating to <strong>Settings</strong> &gt; <strong>&quot;Clear Cache &amp; History&quot;</strong> or visiting the <strong>Privacy Center</strong>.
                </p>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-white dark:bg-slate-900 border border-emerald-200 dark:border-emerald-900/60 space-y-1">
                <h4 className="font-bold text-slate-900 dark:text-white text-xs flex items-center gap-1.5">
                  ...
                  Method B: Direct Developer Support &amp; Verification (डेवलपर सहायता)
                </h4>
                <p className="text-xs text-slate-600 dark:text-slate-400">
                  If you have any questions regarding privacy or data handling, email our developer directly at <a href="mailto:jrahmanansari132@gmail.com" className="font-mono font-bold text-brand-600 dark:text-brand-400 underline">jrahmanansari132@gmail.com</a>. We respond to all inquiries within <strong>24 hours</strong>.
                </p>
              </div>
            </div>

            <div className="text-xs text-slate-500 dark:text-slate-400 pt-1">
              <strong>100% Zero-Cloud Guarantee:</strong> Since no user files or accounts are ever sent to our servers, uninstalling the application immediately removes all app-related files and cache completely from your device.
            </div>
          </section>
